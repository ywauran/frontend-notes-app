          ...
          ({ locale }) => {
            return (
              <form onSubmit={this.onSubmitHandler} className='flex flex-col space-y-4'>
                ...
                <input type='password' placeholder={ locale === 'id' ? 'Kata Sandi' : 'Password'} autoComplete='current-password' value={this.state.password} onChange={this.onPasswordChange} className='w-[80%] mx-auto bg-white text-white border-2 border-black placeholder:text-white px-4 py-2'/>
